...
public abstract class DescribableImpl implements Describable {
  ...
  public void setVersion(String version) {
    LOGGER.debug("Setting version = {}", LogSanitizer.cleanAndEncode(version));
  ...
  public void setId(String id) {
    LOGGER.debug("ENTERING: setId - id = {}", LogSanitizer.cleanAndEncode(id));
    this.id = id;
  ...
  public void setOrganization(String organization) {
    ...
    LOGGER.debug("Setting organization = {}", LogSanitizer.cleanAndEncode(organization));
