      ...
      try (final ByteArrayOutputStream byteArrayOutputStream = new ByteArrayOutputStream();
        ...
        if (session != null) {
          if (LOGGER.isTraceEnabled()) {
            LOGGER.trace("Executing command \"{}\"", LogSanitizer.cleanAndEncode(commandString));
          }
          try {
            ...
            try {
              ...
              if (LOGGER.isInfoEnabled()) {
                LOGGER.info(
                    ...
                    LogSanitizer.cleanAndEncode(commandString),
                    LogSanitizer.cleanAndEncode(commandOutput));
              }
